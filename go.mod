...
require (
	...
	github.com/aaronland/go-http-bootstrap v0.0.9
	...
	github.com/whosonfirst/go-whosonfirst-spatial-reader v0.0.8
	github.com/whosonfirst/go-whosonfirst-spatial-rtree v0.0.6
