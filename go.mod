...
require (
	...
	github.com/aaronland/go-http-bootstrap v0.0.7
	...
	github.com/whosonfirst/go-whosonfirst-spatial-reader v0.0.5
	github.com/whosonfirst/go-whosonfirst-spatial-rtree v0.0.5
